...
import com.kaz3t.proto.hello.HelloResource;
...
public class CxfSpringClient {
    ...
    public static void main(String[] args) {
        ...
        HelloResource helloRestService = JAXRSClientFactory.create(
                "http://localhost:7777", HelloResource.class);
        System.out.print(helloRestService.say());

        /*
         * WebClient helloClient = WebClient.create("http://localhost:7777")
         * .path("hello").accept(MediaType.APPLICATION_JSON); WebClient
         * byeClient = WebClient.create("http://localhost:7777")
